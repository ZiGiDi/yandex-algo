...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
O(1) – в среднем для всех операций, т.к. вставка и нахождение по индексу из массива
...
Несмотря на то, что у каждого элемента есть доп информация O(1) и постоянный размер массива бакетов
     */
